              ...
              {?>
                ...
                <?php 
                  ...
                  {   $id=$_POST['id'];	
                      ...
                      {            
                         echo '<table id="tabListe" class="table" style="height: calc(100vh - 56px);">
                                <thead>
                                  <tr>
                                    <th> De </th> 
                                    <th> À </th> 
                          ...
                          while ($row = mysqli_fetch_array($result3))
                          {
                            ...
                            else 
                            {
                                ...
                                echo "<tr>
                                        <td>".$result5['source']."</td>
                                        <td>".$result5['destination']."</td>
                                        <td>".$result5['datedebut']."</td>
                                        <td>".$result5['duree']."</td>
                                        <td>".$result5['typetrajet']."</td>"?>
                                        <td><a type="button" class="btn btn-success" href="trajet.php?id=<?php echo $row['cid']; ?>" >Réserver</a></td>
                                       <?php echo  
                                    "</tr>";
                            }
                          }
