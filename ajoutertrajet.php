...
$requete = 'INSERT INTO notifications (expediteur, destinataire, cid, timestamp, type,statut) VALUES("'.$destinataire. '","'. $idutilisateur .'","'. $cid .'","'. $aujourdhui .'", 3,"'.$statut.'")';

$result = $conn->query($requete) or die("Erreur 42 :".mysqli_error($conn))  ;

//envoi au destinataire pour approbation

$requete = 'INSERT INTO notifications (expediteur, destinataire, cid, timestamp, type,statut) VALUES("'.$idutilisateur. '","'. $destinataire .'","'. $cid .'","'. $aujourdhui .'", 1,"'.$statut.'")';
