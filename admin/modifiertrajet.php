...
?>
  <body onload="load()">
                          ...
                          if(mysqli_num_rows($result) == 1)
                           {
                                ...
                                if (isset($_POST['modifier'])) 
                                {
                                    ...
                                    if ($mode == "ponctuel") 
                                        ...
                                        $query0="UPDATE notifications SET statut='Trajet modifié' WHERE cid='$id'";
                                        ...
                                        $query3 = "UPDATE offres SET source='$source',destination='$destination',datedebut='$datedebut',
                                                    ...
                                                    typetrajet='$mode',descriptiontrajet='$descriptiontrajet' WHERE id=$id ";
                ...
                ?>   
                <h2 class="text-center"><small>Modifier votre trajet</small></h2>                               
                        ...
                        <input type="hidden" id="total" name="nbRequetes" value=0 />
                            <header class="container-fluid my-5 text-center">
                                ...
                                <div class="container-fluid my-5">
                                    ...
                                    <!-- <input type="text" id="source" name="source" data-provide="typeahead" class="typeahead" placeholder="Source" required/> -->
                            ...
                            <div class="form-floating">
                                    <!-- <input type="text" id="destination" name="destination" data-provide="typeahead" class="typeahead" placeholder="Destination"  required/> -->
                            <select name="destination" class="mt-3 mb-3 form-select" id="floatingSelect" aria-label="Floating label select example" style="height: 60px;">
                                ...
                                <div class="mb-3 pe-3 col-sm-2 form-group">
                                    ...
                                    <input type="time"name="duree" class="form-control"value="<?php echo $duree; ?>" id="Date"  required>
                                </div>
                            </div>
                            <div class="mb-3" style="display: flex;">
                            ...
                            <div class="form-floating d-grid gap-2 ">          
                                <input class="btn btn-primary btn-block mb-3" type="submit" name="modifier" value="Modifier"/>
                            </div>
                        </div>
                        <div class="col-lg-2"></div>
                    </div>
